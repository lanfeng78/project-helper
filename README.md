...
```bash
git clone https://github.com/lanfeng78/project-helper.git
cd project-helper
```
...
```
<img width="1682" height="794" alt="image" src="https://github.com/user-attachments/assets/9720ce30-e609-45a8-8a8a-18aa314a6cb0" />
